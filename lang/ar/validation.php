...
return [
    ...
    'alpha'                => 'يجب أن لا يحتوي حقل :attribute سوى على حرفا.',
    'alpha_dash'           => 'يجب أن لا يحتوي حقل :attribute سوى على حرفا، أرقام ومطّات.',
    'alpha_num'            => 'يجب أن يحتوي حقل :attribute على حرفاٍ وأرقامٍ فقط.',
    ...
    'between'              => [
        ...
        'string'  => 'يجب أن يكون عدد حرفا نّص حقل :attribute بين :min و :max.',
    ],
    ...
    'gt'                   => [
        ...
        'string'  => 'يجب أن يكون طول نّص حقل :attribute أكثر من :value حرفا',
    ],
    'gte'                  => [
        ...
        'string'  => 'يجب أن يكون طول نص حقل :attribute على الأقل :value حرفا',
    ],
    ...
    'lowercase'            => 'يجب أن يحتوي الحقل :attribute على حرفا صغيرة.',
    'lt'                   => [
        ...
        'string'  => 'يجب أن يكون طول نّص حقل :attribute أقل من :value حرفا',
    ],
    'lte'                  => [
        ...
        'string'  => 'يجب أن لا يتجاوز طول نّص حقل :attribute :value حرفا',
    ],
    ...
    'max'                  => [
        ...
        'string'  => 'يجب أن لا يتجاوز طول نّص حقل :attribute :max حرفا',
    ],
    ...
    'min'                  => [
        ...
        'string'  => 'يجب أن يكون طول نص حقل :attribute على الأقل :min حرفا',
    ],
    ...
    'size'                 => [
        ...
        'string'  => 'يجب أن يحتوي نص حقل :attribute على :size حرفاٍا بالضبط.',
    ],
    ...
    'uppercase'            => 'يجب أن يحتوي الحقل :attribute على حرفا كبيرة.',
    ...
    'attributes'           => [
        ...
        "recurrence_repeat_interval" => "فترة التكرار",
        "recurrence_weekly_days" => "أيام التكرار الأسبوعية",
        "recurrence_end_date_time" => "وقت انتهاء التكرار",
        "new_tags" => "وسوم جديدة",
        "new_tags.*" => "وسوم جديدة",
        "url" => 'الرابط'
